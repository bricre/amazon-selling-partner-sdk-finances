# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Finances
...
```shell
composer require bricre/amazon-selling-partner-sdk-finances
```
...
```php
<?php
use Amz\Finances\ResponseTypes;
